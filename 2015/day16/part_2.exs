...
findings = %{children: 3, cats: 7, samoyeds: 2, pomeranians: 3, akitas: 0, vizslas: 0, goldfish: 5, trees: 3, cars: 2, perfumes: 1}

input
  |> String.split("\n", trim: true)
  |> Enum.map(&(String.split(&1, " ")))
  |> Enum.filter(fn(aunt) ->
    [_, number, var1, var1v, var2, var2v, var3, var3v] = aunt
    
    vv1 = var1v
      |> String.slice(0, String.length(var1v) - 1)
      |> String.to_integer
  
    vv2 = var2v
      |> String.slice(0, String.length(var2v) - 1)
      |> String.to_integer
  
    vv3 = var3v
      |> String.to_integer
    
    v1 = var1 |> String.slice(0, String.length(var1) - 1)
    v2 = var2 |> String.slice(0, String.length(var2) - 1)
    v3 = var3 |> String.slice(0, String.length(var3) - 1)
    vs = [v1, v2, v3]
    
    if Enum.member?(vs, "cats") do
      if v1 == "cats" do
        vv1 > findings[:cats]
      else
        if v2 == "cats" do
  ...
  |> Enum.filter(fn(aunt) ->
    ...
    if Enum.member?(vs, "pomeranians") do
      if v1 == "pomeranians" do
        vv1 < findings[:pomeranians]
      else
        if v2 == "pomeranians" do
          vv2 < findings[:pomeranians]
        else
          vv3 < findings[:pomeranians]
        end
      end
    else
      true
  ...
  |> Enum.filter(fn(aunt) ->
    ...
    if Enum.member?(vs, "goldfish") do
      if v1 == "goldfish" do
        vv1 < findings[:goldfish]
      else
        if v2 == "goldfish" do
          vv2 < findings[:goldfish]
        else
          vv3 < findings[:goldfish]
        end
      end
    else
      true
  ...
  |> Enum.filter(fn(aunt) ->
    ...
    if Enum.member?(vs, "children") do
      if v1 == "children" do
        vv1 == findings[:children]
      else
        if v2 == "children" do
          vv2 == findings[:children]
        else
          vv3 == findings[:children]
        end
      end
    else
      true
  ...
  |> Enum.filter(fn(aunt) ->
    ...
    if Enum.member?(vs, "samoyeds") do
      if v1 == "samoyeds" do
        vv1 == findings[:samoyeds]
      else
        if v2 == "samoyeds" do
          vv2 == findings[:samoyeds]
        else
          vv3 == findings[:samoyeds]
        end
      end
    else
      true
  ...
  |> Enum.filter(fn(aunt) ->
    ...
    if Enum.member?(vs, "vizslas") do
      if v1 == "vizslas" do
        vv1 == findings[:vizslas]
      else
        if v2 == "vizslas" do
          vv2 == findings[:vizslas]
        else
          vv3 == findings[:vizslas]
        end
      end
    else
      true
  ...
  |> Enum.filter(fn(aunt) ->
    ...
    if Enum.member?(vs, "perfumes") do
      if v1 == "perfumes" do
        vv1 == findings[:perfumes]
      else
        if v2 == "perfumes" do
          vv2 == findings[:perfumes]
        else
          vv3 == findings[:perfumes]
        end
      end
    else
      true
